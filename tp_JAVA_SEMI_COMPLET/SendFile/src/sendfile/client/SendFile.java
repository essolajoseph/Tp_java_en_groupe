...
public class SendFile extends javax.swing.JFrame {
        ...
        public void run() {
            try {
                while(!Thread.currentThread().isInterrupted()){
                    String data = dis.readUTF();  // IN
                    st = new StringTokenizer(data);
                    String cmd = st.nextToken();  //
                    switch(cmd){
                        case "CMD_RECEIVE_FILE_ERROR":  //  CMD_RECEIVE_FILE_ERROR [Message]
                            String msg = "";
                            while(st.hasMoreTokens()){
                                msg = msg+" "+st.nextToken();
                            }
                            form.updateAttachment(false);
                            JOptionPane.showMessageDialog(SendFile.this, msg, "", JOptionPane.ERROR_MESSAGE);
                            this.closeMe();
                            break;
                            
                        case "CMD_RECEIVE_FILE_ACCEPT":  // CMD_RECEIVE_FILE_ACCEPT [Message]
                        ...
                        case "CMD_SENDFILEERROR":
                            ...
                            JOptionPane.showMessageDialog(SendFile.this, emsg,"", JOptionPane.ERROR_MESSAGE);
                            form.updateAttachment(false);
                        ...
                        case "CMD_SENDFILERESPONSE":
                            ...
                            */
                            ...
                            form.updateAttachment(false);
                            JOptionPane.showMessageDialog(SendFile.this, rMsg, " ", JOptionPane.ERROR_MESSAGE);
                            dispose();
                            break;
                    }
                }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Choisir le Fichier");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(txtFile, javax.swing.GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE))
