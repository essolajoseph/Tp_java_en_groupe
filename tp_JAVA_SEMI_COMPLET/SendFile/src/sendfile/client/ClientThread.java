...
public class ClientThread implements Runnable{
    ...
    public ClientThread(Socket socket, MainForm main){
        ...
        try {
            ...
            main.appendMessage("[IOException]: "+ e.getMessage(), "", Color.RED, Color.RED);
        }
    }
    ...
    public void run() {
        try {
            while(!Thread.currentThread().isInterrupted()){
                String data = dis.readUTF();//lecture de la reponse du serveur
                ...
                switch(CMD){
                    ...
                    case "CMD_FILE_XD":  // Format:  CMD_FILE_XD [sender] [receiver] [filename]
                        ...
                        int confirm = JOptionPane.showConfirmDialog(main, ": "+sender+"\nNom fichier: "+fname);
                        ...
                        if(confirm == 0){
                            ...
                            try {
                                ...
                                String format = "CMD_SEND_FILE_ACCEPT "+sender;
                                dos.writeUTF(format);
                    ...
                    default: 
                        main.appendMessage("[CMDException]:  "+ CMD, "CMDException", Color.RED, Color.RED);
                    break;
                }
            }
        } catch(IOException e){
            main.appendMessage(" Perte de connexion ", "", Color.RED, Color.RED);
        }
    }
}