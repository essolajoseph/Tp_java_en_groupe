...
public class MainForm extends javax.swing.JFrame {
    ...
    public void connect(){
        try {
            ...
            appendMessage("[IOException]: "+ e.getMessage(), "", Color.RED, Color.RED);
        }
    }
    ...
    */
    ...
    public void showOnLineList(Vector list){//liste des client connectes
        try {
    ...
    */
    ...
    public void openFolder(){
        ...
        int open = chooser.showDialog(this, "");
    ...
    private void initComponents() {
        ...
        jMenu3.setText("Partager un fichier");
    ...
    private void sendFileMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendFileMenuActionPerformed
        ...
        if(!attachmentOpen){
            ...
            if(s.prepare(username, host, port, this)){
                ...
                JOptionPane.showMessageDialog(this, "Perte de connexion!", "", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void LogoutMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogoutMenuActionPerformed
        // TODO add your handling code here:
        int confirm = JOptionPane.showConfirmDialog(null, "Quitter la conversation?");
        if(confirm == 0){
            try {
                socket.close();
                setVisible(false);
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        ...
        try {
            ...
            appendMessage("!", "", Color.RED, Color.RED);
        }
