...
public class MainForm extends javax.swing.JFrame {
    ...
    public void setSocketList(Socket socket){
        try {
            ...
            appendMessage("[Initialisation du Socket]: ");
        ...
        for(int x=0; x < clientFileSharingUsername.size(); x++){
            if(clientFileSharingUsername.elementAt(x).equals(username)){
                try {
                    ...
                    appendMessage("[FileSharing]: fichier "+ username);
                } catch (IOException e) {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sendfile/server/server-racks-computer-network-security-260nw-1915654084.jpg"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int confirm = JOptionPane.showConfirmDialog(null, "Stopper le serveur?");
        if(confirm == 0){
            serverThread.stop();
        }
