...
public class SocketThread implements Runnable {
    ...
    private void createConnection(String receiver, String sender, String filename) {
        try {
            ...
            if (s != null) { 
                ...
                main.appendMessage("[createConnection]: '" + receiver + "'");
    ...
    public void run() {
        try {
            while (true) {
                ...
                switch (CMD) {
                    case "CMD_JOIN":
                        ...
                        main.appendMessage("[Client]: " + clientUsername + " A rejoint le chat!");
                        break;
                    ...
                    case "CMD_CHAT":
                        ...
                        try {
                            ...
                            main.appendMessage("[Message]: Vous" + from + " à " + sendTo + " : " + msg);
                        } catch (IOException e) {
                            main.appendMessage("[IOException]: " + sendTo);
                        }
                        break;
                    ...
                    case "CMD_SHARINGSOCKET":
                        main.appendMessage("CMD_SHARINGSOCKET : Client...");
                        ...
                        main.appendMessage("CMD_SHARINGSOCKET : Envoie du fichier");
                        break;

                    case "CMD_SENDFILE":
                        main.appendMessage("CMD_SENDFILE : Client envoie le fichier...");
                        /*
                        ...
                        main.appendMessage("CMD_SENDFILE : vous: " + consignee);
                        main.appendMessage("CMD_SENDFILE : a: " + sendto);
                        /**
                         * 
                         */
                        ...
                        if (cSock != null) { /* Exists   */
                            ...
                            main.removeClientFileSharing(consignee);
                            main.appendMessage("CMD_SENDFILE : Client '" + sendto + "");
                            DataOutputStream dos = new DataOutputStream(socket.getOutputStream());
                    ...
                    default:
                        main.appendMessage("[CMDException]:  " + CMD);
                        break;
                }
            }
        } catch (IOException e) {
            ...
            main.appendMessage("[SocketThread]: Client déconnecté !");
        }
    }
